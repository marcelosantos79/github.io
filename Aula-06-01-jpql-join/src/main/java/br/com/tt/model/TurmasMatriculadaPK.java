...
/**
 * The primary key class for the turmas_matriculadas database table.
 * 
 */
@Embeddable
public class TurmasMatriculadaPK implements Serializable {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof TurmasMatriculadaPK)) {
			return false;
		}
		TurmasMatriculadaPK castOther = (TurmasMatriculadaPK)other;
		return 
